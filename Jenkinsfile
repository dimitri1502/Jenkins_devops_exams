    ...
    stage('Helm Deploy - QA') {
      ...
      steps {
        script {
          ...
          helm upgrade --install movie-service/app charts --values values-qa.yaml --namespace qa --create-namespace
          '''
        }
      }
    }
    ...
    stage('Helm Deploy - Staging') {
      ...
      steps {
        script {
          ...
          helm upgrade --install movie-service/app charts --values values-staging.yaml --namespace staging --create-namespace
          '''
        }
      }
    }
    ...
    stage('Helm Deploy - Prod') {
      ...
      steps {
        ...
        script {
          ...
          helm upgrade --install movie-service/app charts --values values-prod.yaml --namespace prod --create-namespace
          '''
        }
      }
    }
